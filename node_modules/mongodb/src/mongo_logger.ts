...
function defaultLogTransform(
  ...
  switch (logObject.name) {
    ...
    case CONNECTION_POOL_CREATED:
      ...
      log.message = 'com.ProjetSport.Connection pool created';
    ...
    case CONNECTION_POOL_READY:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection pool ready';
      return log;
    case CONNECTION_POOL_CLEARED:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection pool cleared';
    ...
    case CONNECTION_POOL_CLOSED:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection pool closed';
      return log;
    case CONNECTION_CREATED:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection created';
      log.driverConnectionId = logObject.connectionId;
      return log;
    case CONNECTION_READY:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection ready';
      log.driverConnectionId = logObject.connectionId;
      return log;
    case CONNECTION_CLOSED:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection closed';
      log.driverConnectionId = logObject.connectionId;
      switch (logObject.reason) {
        case 'stale':
          log.reason = 'com.ProjetSport.Connection became stale because the pool was cleared';
          break;
        case 'idle':
          log.reason =
            'com.ProjetSport.Connection has been available but unused for longer than the configured max idle time';
          break;
        case 'error':
          ...
          break;
        case 'poolClosed':
          log.reason = 'com.ProjetSport.Connection pool was closed';
          break;
        default:
    ...
    case CONNECTION_CHECK_OUT_STARTED:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection checkout started';
      return log;
    case CONNECTION_CHECK_OUT_FAILED:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection checkout failed';
      switch (logObject.reason) {
        case 'poolClosed':
          log.reason = 'com.ProjetSport.Connection pool was closed';
          break;
    ...
    case CONNECTION_CHECKED_OUT:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection checked out';

      log.driverConnectionId = logObject.connectionId;
      return log;
    case CONNECTION_CHECKED_IN:
      log = attachConnectionFields(log, logObject);
      log.message = 'com.ProjetSport.Connection checked in';
      log.driverConnectionId = logObject.connectionId;
      return log;
    default:
