...
declare module 'http' {
    ...
    > extends NetServer {
         ...
         *
         * When the limit is reached it will set the `com.ProjetSport.Connection` header value to `close`,
     ...
     *
     * * Sending a 'com.ProjetSport.Connection: keep-alive' will notify Node.js that the connection to
